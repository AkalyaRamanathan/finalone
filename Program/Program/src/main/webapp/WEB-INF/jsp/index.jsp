...
<div class="form-w3ls">
    ...
    <div class="tab-content">
        <div id="signin-agile">   
			<form action="/customer"
			 ...
			 <p>Already have an account? <a href="http://localhost:9098/login">Sign IN</a>.</p>
		</div>
		<div id="signup-agile">   
			<form action="/merchant" method="post">
				...
				<input type="text" name="merchantName" placeholder="Your Full Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Full Name';}" required="required">
    ...
    <label for="female" class="radio">Female</label>
				...
				<p class="header">Address</p>
				<input type="text" name="address" placeholder="Your address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your ProductType';}" required="required">
			 ...
			 <p>Already have an account? <a href="http://localhost:9098/login">LOG IN</a>.</p>
		</div> 
    </div><!-- tab-content -->
</div> <!-- /form -->	  
